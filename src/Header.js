        ...
        <div className="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
          ...
          <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20"
            ...
            <ul className="list-reset lg:flex flex-1 items-center px-4 md:px-0">
              ...
              <li className="mr-6 my-2 md:my-0">
                <NavLink exact={true} activeClassName="text-purple-600 border-purple-600" to={"/patients"} className="block py-1 md:py-3 pl-1 align-middle no-underline hover:text-gray-900 border-b-2 hover:border-purple-600">
                  <i className="fas fa-address-book fa-fw mr-3 text-purple-600"/>
                  <span className="pb-1 md:pb-0 text-sm">Pacjenci</span>
                </NavLink>
              </li>
            </ul>
